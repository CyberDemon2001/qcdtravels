  ...
  return (
    <section className="max-w-full mx-auto px-6 md:px-12 lg:px-24 py-10 lg:py-24 bg-white overflow-hidden">
      ...
      >
        ...
        <motion.button 
          className="bg-gradient-to-r from-red-600 to-blue-700 hover:bg-red-600 text-white px-8 py-4 rounded-2xl flex items-center gap-4 transition-all duration-300 text-xs font-black shadow-lg uppercase tracking-widest"
          whileHover={{ y: -5 }}
          initial={{ opacity: 0, x: 20 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
