          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              ...
              <button 
                type="submit"
                disabled={loading}
                className="w-full py-5 bg-gradient-to-r from-red-600 to-blue-700 hover:bg-black text-white rounded-2xl font-black uppercase tracking-[0.2em] text-xs transition-all duration-500 flex items-center justify-center gap-3 group shadow-xl shadow-red-600/20 disabled:opacity-50"
              >
